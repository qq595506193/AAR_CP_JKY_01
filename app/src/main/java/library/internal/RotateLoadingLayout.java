...
//		mRotateDrawableWhilePulling = attrs.getBoolean(MResource.getIdByName(getContext().getApplicationContext(), "styleable", "PullToRefresh_ptrRotateDrawableWhilePulling"), true);
...
//		return MResource.getIdByName(getContext().getApplicationContext(), "drawable", "default_ptr_rotate");

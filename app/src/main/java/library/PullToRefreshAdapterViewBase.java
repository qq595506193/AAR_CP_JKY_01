...
import library.internal.IndicatorLayout;
...
//		mShowIndicator = a.getBoolean(MResource.getIdByName(getContext().getApplicationContext(), "style", "PullToRefresh_ptrShowIndicator"), !isPullToRefreshOverScrollEnabled());
...
//			params.rightMargin = getResources().getDimensionPixelSize(MResource.getIdByName(getContext().getApplicationContext(), "dimen", "indicator_right_padding"));
